...
Retropak is an open container format for distributing retro software with rich metadata, artwork, soundtracks, and documentation. It's designed to be the "FLAC of ROMs"—a single, self-contained package that preserves everything about a title.
